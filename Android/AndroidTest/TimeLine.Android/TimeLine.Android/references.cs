...
namespace uCook_TimeLineHost
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="TimeLineData", Namespace="http://schemas.datacontract.org/2004/07/uCook_TimeLineHost")]
    public partial class TimeLineData : object
    {
...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="ITimeLine")]
public interface ITimeLine
{
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ITimeLine/SayHelloTo", ReplyAction="http://tempuri.org/ITimeLine/SayHelloToResponse")]
    ...
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ITimeLine/GetHelloData", ReplyAction="http://tempuri.org/ITimeLine/GetHelloDataResponse")]
    System.IAsyncResult BeginGetHelloData(uCook_TimeLineHost.TimeLineData helloWorldData, System.AsyncCallback callback, object asyncState);
    
    uCook_TimeLineHost.TimeLineData EndGetHelloData(System.IAsyncResult result);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface ITimeLineChannel : ITimeLine, System.ServiceModel.IClientChannel
{
}
...
public partial class GetHelloDataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
{
    ...
    public uCook_TimeLineHost.TimeLineData Result
    {
        get
        {
            base.RaiseExceptionIfNecessary();
            return ((uCook_TimeLineHost.TimeLineData)(this.results[0]));
        }
    }
}
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class TimeLineClient : System.ServiceModel.ClientBase<ITimeLine>, ITimeLine
{
    ...
    public TimeLineClient(string endpointConfigurationName) : 
            base(endpointConfigurationName)
    {
    }
    
    public TimeLineClient(string endpointConfigurationName, string remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public TimeLineClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public TimeLineClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
    ...
    System.IAsyncResult ITimeLine.BeginSayHelloTo(string name, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginSayHelloTo(name, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    string ITimeLine.EndSayHelloTo(System.IAsyncResult result)
    {
    ...
    private System.IAsyncResult OnBeginSayHelloTo(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        return ((ITimeLine)(this)).BeginSayHelloTo(name, callback, asyncState);
    }
    
    private object[] OnEndSayHelloTo(System.IAsyncResult result)
    {
        string retVal = ((ITimeLine)(this)).EndSayHelloTo(result);
        return new object[] {
                retVal};
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult ITimeLine.BeginGetHelloData(uCook_TimeLineHost.TimeLineData helloWorldData, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginGetHelloData(helloWorldData, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    uCook_TimeLineHost.TimeLineData ITimeLine.EndGetHelloData(System.IAsyncResult result)
    {
    ...
    {
        uCook_TimeLineHost.TimeLineData helloWorldData = ((uCook_TimeLineHost.TimeLineData)(inValues[0]));
        return ((ITimeLine)(this)).BeginGetHelloData(helloWorldData, callback, asyncState);
    }
    
    private object[] OnEndGetHelloData(System.IAsyncResult result)
    {
        uCook_TimeLineHost.TimeLineData retVal = ((ITimeLine)(this)).EndGetHelloData(result);
        return new object[] {
                retVal};
    }
    ...
    public void GetHelloDataAsync(uCook_TimeLineHost.TimeLineData helloWorldData)
    {
        this.GetHelloDataAsync(helloWorldData, null);
    }
    
    public void GetHelloDataAsync(uCook_TimeLineHost.TimeLineData helloWorldData, object userState)
    {
    ...
    protected override ITimeLine CreateChannel()
    {
        return new TimeLineClientChannel(this);
    }
    
    private class TimeLineClientChannel : ChannelBase<ITimeLine>, ITimeLine
    {
        
        public TimeLineClientChannel(System.ServiceModel.ClientBase<ITimeLine> client) : 
                base(client)
        {
        }
        ...
        public System.IAsyncResult BeginGetHelloData(uCook_TimeLineHost.TimeLineData helloWorldData, System.AsyncCallback callback, object asyncState)
        {
            object[] _args = new object[1];
        ...
        public uCook_TimeLineHost.TimeLineData EndGetHelloData(System.IAsyncResult result)
        {
            object[] _args = new object[0];
            uCook_TimeLineHost.TimeLineData _result = ((uCook_TimeLineHost.TimeLineData)(base.EndInvoke("GetHelloData", _args, result)));
            return _result;
        }
    }
}
